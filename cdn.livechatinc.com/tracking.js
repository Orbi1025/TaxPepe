!(function () {
        ...
        if (t.error)
          switch (t.error.type) {
            case "misdirected_request":
              return Qt({ ...e, region: t.error.data.region });
      ...
      const c = new BroadcastChannel(
        ...
        s = d(300, async function () {
          ...
          const o = Ve(t.state, "liveChatChatId").active,
            c = "maximized" === Xe(t.state).visibility.state;
          if (!o || !c) return;
          ...
          window.documentPictureInPicture
            ...
            .then((e) => {
              ...
              const { config: c, rtl: s } = Xe(t.state);
  ...
  var Pi = (e, t, n) => {
      ...
      const a = (e) => {
        ...
        s = () => {
          const o = nt("div", ut),
            r = xi(t);
          Ke({ bottom: i.y + "px", [r]: i.x + "px" }, o);
          const s = nt("div", pt);
          15 > i.x && "right" === r && Ke({ [r]: 10 - i.x + "px" }, s),
            (s.innerHTML = "&times;");
          const l = nt("div", mt),
  ...
  function Zi(e, t) {
    ...
    } else e.call("storeMethod", ["requestUpdateUser", Ye(e.state), t]);
  }
  function Qi(e, t) {
  ...
  const to = "liveChatChatId",
    no = function (e) {
      for (
        ...
        n[i - 1] = arguments[i];
      return jn(Xi.apply(void 0, [e].concat(n)));
    };
  function io(e, t, n) {
    ...
    we(
      ...
      Ki(e, i, "on_postchat_survey_submitted"),
      Ki(e, i, "on_prechat_survey_submitted"),
      Ki(e, i, "on_rating_comment_submitted"),
      Ki(e, i, "on_rating_submitted"),
      Ki(e, i, "on_ticket_created"),
      (i.set_custom_variables = (t) => {
        Ri("LC_API.set_custom_variables", t), Qi(e, $i(t));
      }),
      (i.update_custom_variables = (t) => {
        Ri("LC_API.update_custom_variables", t), Zi(e, { properties: $i(t) });
      }),
      (i.set_visitor_name = (t) => {
        Ri("LC_API.set_visitor_name", t), Zi(e, { name: eo(t) });
      }),
      (i.set_visitor_email = (t) => {
        Ri("LC_API.set_visitor_email", t), Zi(e, { email: eo(t) });
      }),
      (i.open_chat_window =
        i.show_full_view =
      ...
      (i.agents_are_available = () => (
        ...
        "online" === Xe(e.state, "availability")
      )),
  ...
  const oo = {
      ...
      navigate(e, t) {
        void 0 === t && (t = "_blank"),
          jn(() => {
            window.location.origin === X(e) && "function" == typeof this.handler
              ? this.handler(te(e))
              : window.open(e, t);
          });
      },
  ...
  function uo(e, t, n) {
    ...
    function m(t, n, o) {
      switch (n) {
        ...
        case "rich_message_button_clicked":
          return void i[t](n, o);
        case "ready":
          return void (Xe(e.state, "readyState") !== D
            ? jn(() =>
    ...
    function g(t) {
      switch (t) {
        ...
        case "features":
          return s(Xe(e.state).config.features);
        default:
          return void console.error(
    ...
    function w(n, i) {
      switch (
        ...
        case "set_customer_name":
          return void Zi(e, { name: eo(i) });
        case "set_customer_email":
          return void Zi(e, { email: eo(i) });
        case "update_session_variables":
          return void Zi(e, { properties: c(String, i) });
        case "trigger_sales_tracker":
  ...
  const yo = Ft(),
    ...
    xo = (e, t) => {
      ...
      return Ke({ width: r, height: a, [xi(e, yo)]: i.x + "px", ...o }, n), n;
    },
    Io = (e, t, n, i, o, r, a) => {
      var c, s;
      let d = G(
        ...
        "livechat" === r &&
          ...
          ((e) => {
            ...
            const a = we(
              ...
              he(() => "maximized" === Xe(e.state).visibility.state),
              be(() => !document.hidden)
            );
            we(
              a,
  ...
  function zo() {
    et().then((e) => {
      [
        "https://cdn.livechatinc.com/widget/static/js/configurator.BOamplZi.js",
      ].forEach((t) => {
        ((e, t) => {
